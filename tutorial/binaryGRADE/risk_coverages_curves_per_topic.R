...
file1 = paste("/home/simon/Apps/SysRevData/data/modelling/plots/evidencegrader/evidencegrader_aurc_raw_", criterion, "_debias_area.csv", sep="")
#file1 = paste("/home/simon/Apps/SysRevData/data/modelling/plots/sepsis/sepsis_aurc_raw_", criterion, "_debias.csv", sep="")
f1 = read.table(file1, skip = 0, sep = "\t", header=TRUE, na.strings = "NA", dec = ".", strip.white = TRUE)
all = data.frame(f1)
all$model=factor(all$model)
...
my = ggplot(data = all_subset, aes(x = coverage, y = risk, colour=model, linetype=model)) + geom_line() + theme_bw() + #ggtitle(paste(criterion, topic_name, sep=": ")) +
      scale_y_continuous(breaks = 0:10 / 10, limits=c(0,0.45)) +
    theme(plot.title = element_text(size = 14, hjust=0.5),
          ...
          panel.border = element_blank())
f_out=paste("/home/simon/Apps/SysRevData/data/dataset/plots/risk_coverages_curves/evidencegrader/aurc_raw_compare_area", gsub(" ", "_", criterion), topic_name, ".png", sep="")
ggsave(f_out, width = 8, height = 5)


file1 = paste("/home/simon/Apps/SysRevData/data/modelling/plots/evidencegrader/evidencegrader_aurc_raw_", criterion, "_debias_sex.csv", sep="")
f1 = read.table(file1, skip = 0, sep = "\t", header=TRUE, na.strings = "NA", dec = ".", strip.white = TRUE)
all = data.frame(f1)
all$model=factor(all$model)
all$topic=factor(all$topic)
...
my = ggplot(data = all_subset, aes(x = coverage, y = risk, colour=model, linetype=model)) + geom_line() + theme_bw() + #ggtitle(paste(criterion, topic_name, sep=": ")) +
    ...
    theme(plot.title = element_text(size = 14, hjust=0.5),
          ...
          #legend.position = "none",
          panel.border = element_blank())
f_out=paste("/home/simon/Apps/SysRevData/data/dataset/plots/risk_coverages_curves/evidencegrader/aurc_raw_compare_sex", gsub(" ", "_", criterion), topic_name, ".png", sep="")
ggsave(f_out, width = 8, height = 5)



file1 = "/home/simon/Apps/SysRevData/data/modelling/plots/robotreviewer/robotreviewer_aurc_raw_RoB_debias_area.csv"
f1 = read.table(file1, skip = 0, sep = "\t", header=TRUE, na.strings = "NA", dec = ".", strip.white = TRUE)
all = data.frame(f1)
all$model=factor(all$model)
all$topic=factor(all$topic)
...
my = ggplot(data = all_subset, aes(x = coverage, y = risk, colour=model, linetype=model)) + geom_line() + theme_bw() + #ggtitle(paste(criterion, topic_name, sep=": ")) +
    ...
    theme(plot.title = element_text(size = 14, hjust=0.5),
          ...
          #legend.position = "none",
          panel.border = element_blank())
f_out=paste("/home/simon/Apps/SysRevData/data/dataset/plots/risk_coverages_curves/robotreviewer/aurc_raw_compare_area", topic_name, ".png", sep="")
ggsave(f_out, width = 8, height = 5)


file1 = "/home/simon/Apps/SysRevData/data/modelling/plots/robotreviewer/robotreviewer_aurc_raw_RoB_debias_sex.csv"
f1 = read.table(file1, skip = 0, sep = "\t", header=TRUE, na.strings = "NA", dec = ".", strip.white = TRUE)
all = data.frame(f1)
all$model=factor(all$model)
all$topic=factor(all$topic)
...
my = ggplot(data = all_subset, aes(x = coverage, y = risk, colour=model, linetype=model)) + geom_line() + theme_bw() + #ggtitle(paste(criterion, topic_name, sep=": ")) +
    ...
    theme(plot.title = element_text(size = 14, hjust=0.5),
          ...
          #legend.position = "none",
          panel.border = element_blank())
f_out=paste("/home/simon/Apps/SysRevData/data/dataset/plots/risk_coverages_curves/robotreviewer/aurc_raw_compare_sex", topic_name, ".png", sep="")
ggsave(f_out, width = 8, height = 5)
