...
file1 = paste("/home/simon/Apps/SysRevData/data/modelling/plots/evidencegrader/evidencegrader_perf_raw_", criterion, "_debias.csv", sep="")
...
all$topic <- factor(all$topic, levels = all$topic[order(all$precision[all$model=="vanilla"])])
...
f_out=paste("/home/simon/Apps/SysRevData/data/dataset/plots/risk_coverages_curves/evidencegrader/debias/precision_compare", gsub(" ", "_", criterion), ".png", sep="")
